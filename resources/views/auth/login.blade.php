    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative">
            ...
            <div class="w-full max-w-md mt-10 lg:mt-0">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <!-- Email/No. HP -->
                    <div>
                        <label for="email" class="block text-sm font-medium text-slate-700 mb-2">Email atau Nomor
                            HP</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password"
                                class="block w-full pl-10 pr-10 py-3.5 border border-slate-200 rounded-xl focus:ring-primary focus:border-primary bg-slate-50 focus:bg-white transition-colors sm:text-sm"
        ...
        <div
            ...
            <div class="relative z-10 w-full max-w-lg text-white">
                ...
                <h3 class="font-heading text-4xl font-bold mb-6 leading-snug">Pantau Estimasi Anda secara Real-Time.</h3>
